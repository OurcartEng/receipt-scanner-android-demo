...
## Installation
Create a libs folder in the main folder of your app and put there files `opencv-release.aar` and `receiptScanner-release.aar`.

Then add to your `build.gradle.kts` dependencies:
```agsl
dependencies {
...
- **ourcartBackgroundSecondaryColor** (default: `#ffffff`) -  background of tile buttons, action bars and modals
